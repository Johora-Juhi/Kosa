                ...
                <form onSubmit={handleClientRequest}>
                    ...
                    <div className="row px-3 contactUss mt-4">
                        ...
                        <select ref={choiceRef}
                            ...
                            <option style={{ color: '#000' }} value="">Choose your preference</option>
                            <option style={{ color: '#000' }} value="coloring">Coloring</option>
                            <option style={{ color: '#000' }} value="rebonding">Rebonding</option>
                            <option style={{ color: '#000' }} value="style">Style</option>
                        </select>
                    </div>
                    <div className="row px-3 contactUss mt-4">
                        <label className='mb-3' htmlFor="">MESSAGE</label>
                        <textarea className='mx-2' ref={messageRef} name="" id="" cols="30" rows="4" placeholder='Enter Your Message'></textarea>
                    </div>
