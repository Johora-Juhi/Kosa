...
const CheckoutForm = () => {
  ...
  const subTotal = eachProductCost
  ...
  const handlePlaceOrder = (data) => {
    ...
    fetch("https://hair-saloon-server.vercel.app/orderPlace", {
      method: "POST",
      headers: {
      ...
      <div className="mt-4">
        ...
        >
          ...
          <div className="d-flex justify-content-between border-top border-bottom px-2">
            <div style={{ fontSize: "17px" }} className="mb-0 py-3">
              Product Price
            </div>
            <div style={{ fontSize: "17px" }} className="mb-0 py-3">
              £{subTotal}
          ...
          <div className="d-flex justify-content-between border-bottom px-2">
            <div style={{ fontSize: "17px" }} className="mb-0 py-3 fw-bold">
              Total Amount
            </div>
            <div
              style={{ fontSize: "17px", color: "black" }}
              className="mb-0 py-3 fw-bold"
            >
              £{subTotal}
            </div>
          </div>
